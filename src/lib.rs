...
#![cfg_attr(
    feature = "rgw",
    doc = "* [`rgw`]: [Ceph RADOS Gateway](https://docs.ceph.com/en/latest/radosgw/) via SAL C API. See [`RGWObjectStoreBuilder`](rgw::RGWObjectStoreBuilder)"
)]
//!
...
pub mod http;
#[cfg(feature = "rgw")]
#[cfg_attr(docsrs, doc(cfg(feature = "rgw")))]
pub mod rgw;
pub mod limit;
